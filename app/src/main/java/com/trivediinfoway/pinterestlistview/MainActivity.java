...
public class MainActivity extends Activity {
    ...
    private void loadItems(){
        Integer[] leftItems = new Integer[]{R.drawable.ic_1, R.drawable.ic_7, R.drawable.ic_3, R.drawable.ic_4, R.drawable.ic_5};
        Integer[] rightItems = new Integer[]{R.drawable.ic_6, R.drawable.ic_2, R.drawable.ic_8, R.drawable.ic_9, R.drawable.ic_10};
